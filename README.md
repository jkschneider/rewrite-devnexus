...
3. Changing the package structure from `com.devnexus` to whatever you want.
...
* [META-INF/rewrite/stringutils.yml](./src/main/resources/META-INF/rewrite/stringutils.yml) - A declarative YAML recipe that replaces usages of `org.springframework.util.StringUtils` with `org.apache.commons.lang3.StringUtils`.
  - [UseApacheStringUtilsTest](./src/test/java/com/devnexus/UseApacheStringUtilsTest.java) - A test class for the `com.devnexus.UseApacheStringUtils` recipe.
* [NoGuavaListsNewArrayList.java](./src/main/java/com/devnexus/NoGuavaListsNewArrayList.java) - An imperative Java recipe that replaces usages of `com.google.common.collect.Lists` with `new ArrayList<>()`.
  - [NoGuavaListsNewArrayListTest.java](./src/test/java/com/devnexus/NoGuavaListsNewArrayListTest.java) - A test class for the `NoGuavaListsNewArrayList` recipe.
* [SimplifyTernary](./src/main/java/com/devnexus/SimplifyTernary.java) - An Refaster style recipe that simplifies ternary expressions.
  - [SimplifyTernaryTest](./src/test/java/com/devnexus/SimplifyTernaryTest.java) - A test class for the `SimplifyTernary` recipe.
* [AssertEqualsToAssertThat](./src/main/java/com/devnexus/AssertEqualsToAssertThat.java) - An imperative Java recipe that replaces JUnit's `assertEquals` with AssertJ's `assertThat`, to show how to handle classpath dependencies.
  - [AssertEqualsToAssertThatTest](./src/test/java/com/devnexus/AssertEqualsToAssertThatTest.java) - A test class for the `AssertEqualsToAssertThat` recipe.
* [AppendToReleaseNotes](./src/main/java/com/devnexus/AppendToReleaseNotes.java) - A ScanningRecipe that appends a message to the release notes of a project.
  - [AppendToReleaseNotesTest](./src/test/java/com/devnexus/AppendToReleaseNotesTest.java) - A test class for the `AppendToReleaseNotes` recipe.
* [ClassHierarchy](./src/main/java/com/devnexus/ClassHierarchy.java) - A recipe that demonstrates how to produce a data table on the class hierarchy of a project.
  - [ClassHierarchyTest](./src/test/java/com/devnexus/ClassHierarchyTest.java) - A test class for the `ClassHierarchy` recipe.
* [UpdateConcoursePipeline](./src/main/java/com/devnexus/UpdateConcoursePipeline.java) - A recipe that demonstrates how to update a Concourse pipeline, as an example of operating on Yaml files.
  - [UpdateConcoursePipelineTest](./src/test/java/com/devnexus/UpdateConcoursePipelineTest.java) - A test class for the `UpdateConcoursePipeline` recipe.
    ...
    <build>
        <plugins>
            <plugin>
                ...
                <configuration>
                    <activeRecipes>
                        <recipe>com.devnexus.NoGuavaListsNewArrayList</recipe>
                    </activeRecipes>
                </configuration>
                <dependencies>
                    <dependency>
                        <groupId>com.devnexuscom.devnexus</groupId>
...
dependencies {
    rewrite("com.devnexus:rewrite-recipe-starter:latest.integration")
}

rewrite {
    activeRecipe("com.devnexus.NoGuavaListsNewArrayList")
}
```
